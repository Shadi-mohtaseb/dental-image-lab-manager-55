-- إزالة التريجرات التي تسبب التداخل المفرط
DROP TRIGGER IF EXISTS auto_distribute_profits_on_cases ON public.cases;
DROP TRIGGER IF EXISTS auto_distribute_profits_on_expenses ON public.expenses;
DROP TRIGGER IF EXISTS auto_distribute_profits_on_partners ON public.partners;

-- إزالة دالة التريجر
DROP FUNCTION IF EXISTS public.auto_distribute_profits_trigger();
...
-- رفع الحد الأقصى لعمق المكدس إذا لزم الأمر
